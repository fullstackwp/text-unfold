...
class FSWP_ELT_text_unfold extends Widget_Base
{
    ...
    ?>
        <div class="<?php echo esc_attr( FSWP_ELT_CLASS_PREFIX . 'read-more-image-wrapper' ); ?>">
            <?php echo ( Group_Control_Image_Size::get_attachment_image_html( $settings, 'read_more_image_size', 'read_more_image' ) ); ?>
        </div><!--read-more-image-wrapper-->
    <?php
    }

    /**
	 * Register Widget Read More Text controls.
	 *
	 * @since 1.0.0
	 * @access private
	 */
    ...
    /**
	 * Register Widget Read More section.
	 *
	 * @since 1.0.0
	 * @access private
	 */
    ...
    ?>
        <div class="<?php echo esc_attr( FSWP_ELT_CLASS_PREFIX . 'read-more-content-wrapper' ); ?>">
            ...
            ?>
                ...
                ?>
                    <a class="<?php echo esc_attr( FSWP_ELT_CLASS_PREFIX . 'read-more more' ); ?>" data-height="<?php echo esc_attr( $height ); ?>" data-more="<?php echo esc_attr( $settings['read_more_text'] ); ?>" data-less="<?php echo esc_attr( $settings['read_less_text'] ); ?>">
